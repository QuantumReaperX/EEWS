...
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, sharex='col', sharey='row', figsize=(20, 40))
...
def animate(i, xs, ys1, ys2, ys3):
    ...
    ys1.append(accel_3.acceleration[0])
    ys2.append(accel_3.acceleration[1])
    ys3.append(accel_3.acceleration[2])
    #ys4.append(accel_1.acceleration)
    print(accel_3.acceleration)
    print(accel_3.data_rate, accel_3.range)
    time.sleep(1)
...
ani = FuncAnimation(fig, animate, fargs=(xs, ys1, ys2, ys3), interval=1000)
#plt.tight_layout()
plt.show()